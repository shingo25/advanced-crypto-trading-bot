...
def test_trading_engine_import():
    ...
    try:
        from backend.trading.engine import TradingEngine, Order, Position, OrderType, OrderStatus, OrderSide
...
def test_order_cancellation():
    ...
    try:
        from backend.trading.engine import TradingEngine, OrderType, OrderSide, OrderStatus
...
def test_alert_manager_import():
    ...
    try:
        from backend.monitoring.alerts import AlertManager, Alert, AlertLevel, AlertType
...
def test_performance_monitor():
    ...
    try:
        ...
        # 戦略パフォーマンスを更新
        performance_monitor.update_strategy_performance("test_strategy", {
