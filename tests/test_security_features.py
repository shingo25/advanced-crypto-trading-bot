...
from src.backend.core.api_key_manager import APIKeyManager, get_secure_api_credentials, validate_exchange_credentials
from src.backend.core.config import Settings
from src.backend.core.rate_limiter import EnhancedRateLimiter, get_client_ip, get_rate_limit_status, get_user_id_or_ip
...
class TestConfigSecurity:
    ...
    def test_production_password_validation(self):
        ...
        with patch.dict(os.environ, {"ENVIRONMENT": "production", "ADMIN_PASSWORD": "change_this_password"}):
    ...
    def test_production_environment_properties(self):
        ...
        with patch.dict(
            os.environ,
            {
                ...
                "ADMIN_PASSWORD": "VerySecureProductionSecret123!@#NoCommonWords",
...
class TestRateLimiter:
    ...
    def test_get_client_ip_real_ip(self):
        ...
        request = MagicMock()
        request.headers.get.side_effect = lambda header: {"X-Forwarded-For": None, "X-Real-IP": "203.0.113.195"}.get(
            header
        )
    ...
    def test_audit_results_structure(self):
        ...
        with patch.object(self.manager, "get_exchange_credentials") as mock_get_creds:
            mock_get_creds.return_value = (
                "test_key_123456789012345678901234567890123456789012345678901234567890",
                "test_secret_123456789012345678901234567890123456789012345678901234567890",
            )
