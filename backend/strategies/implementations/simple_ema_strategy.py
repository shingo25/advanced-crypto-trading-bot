...
class SimpleEMAStrategy(BaseStrategy):
    ...
    def __init__(self, 
        ...
        logger.info(f"Simple EMA Strategy initialized: fast={self.parameters['ema_fast']}, slow={self.parameters['ema_slow']}")
    ...
    def generate_signals(self, data) -> List[Signal]:
        ...
        # ロングイグジット条件
              ...
              ((current_ema_fast < current_ema_slow and prev_ema_fast >= prev_ema_slow) or
