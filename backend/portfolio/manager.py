...
class PortfolioManager:
    ...
    def create_portfolio(self, name: str, initial_allocation: Dict[str, float] = None) -> Portfolio:
        """ポートフォリオを作成"""
    ...
    def _get_risk_reduction_actions(self, portfolio: Portfolio, risk_assessment: Dict[str, Any]) -> List[Dict[str, Any]]:
        """リスク軽減アクションを取得"""
        actions = []
