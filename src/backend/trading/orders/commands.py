...
class OrderCommand(ABC):
    ...
    async def validate(self, request_context: Dict = None, portfolio_value: Optional[Decimal] = None) -> tuple[bool, Optional[str]]:
        """
        包括的な注文バリデーション
...
class CreateOrderCommand(OrderCommand):
        ...
        try:
            ...
            if exchange_response["success"]:
                ...
                result = OrderResult.error_result(
                    ...
                    exchange_response.get("error_code")
                )
    ...
    async def _submit_to_exchange(self) -> Dict:
        ...
        try:
            ...
            return {
                "success": True,
                "order_id": f"exchange_{self.order.id[:8]}",
                "status": "submitted"
            }
        except Exception as e:
            return {
    ...
    async def execute(self) -> OrderResult:
        ...
        try:
            ...
            if cancel_response["success"]:
                ...
                result = OrderResult.error_result(
                    cancel_response.get("error", "Cancel failed"),
                    cancel_response.get("error_code")
                )
    ...
    async def execute(self) -> OrderResult:
        ...
        try:
            ...
            if modify_response["success"]:
                ...
                result = OrderResult.error_result(
                    modify_response.get("error", "Modify failed"),
                    modify_response.get("error_code")
                )
