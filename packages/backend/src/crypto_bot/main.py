...
from crypto_bot.core.local_database import init_local_db
from crypto_bot.core.logging import setup_logging
from crypto_bot.streaming import price_stream_manager

# Streaming system
from crypto_bot.streaming import router as streaming_router

# from crypto_bot.api import config, trades
# WebSocket system
from crypto_bot.websocket import router as websocket_router
...
async def readiness_check():
    ...
    if not is_ci_environment:
        ...
        try:
            from crypto_bot.core.database import _get_database_instance
